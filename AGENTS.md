...
Planejo fazer um SaaS de estoque e venda MUITO simples apenas para aprendizado inicial, utilizando Python, FastAPI, JWT, PostgreSQL, SQLAlchemy, Alembic, Docker. Nao tenho planos para o frontend, pois meu foco e aprender backend.

inicialmente, pensei apenas em termos sistemas para : login com JWT, adicionar produtos ao estoque, anunciar produtos (vender).
